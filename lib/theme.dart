...
Color successColor = Color.fromARGB(255, 54, 253, 104);
Color priceColor = Color(0xff2C96F1);
Color backgroundCalor1 = Color(0xff1F1D2B);
Color backgroundCalor2 = Color(0xff2B2937);
Color backgroundCalor3 = Color(0xff242231);
Color backgroundCalor4 = Color(0xff252836);
Color backgroundCalor5 = Color(0xff2B2844);
Color primaryTextColor = Color(0xffF1F0F2);
Color secondaryTextColor = Color(0xff999999);
Color subtitleColor = Color(0xff504F52);
...
FontWeight requler = FontWeight.w400;
